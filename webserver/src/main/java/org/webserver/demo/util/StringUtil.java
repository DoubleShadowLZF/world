package org.webserver.demo.util;

import java.io.UnsupportedEncodingException;
import java.lang.Character.UnicodeBlock;

public class StringUtil {
    public static String utf82Gbk(String utf8Str) throws UnsupportedEncodingException {
        String utf8  = new String(utf8Str.getBytes());
